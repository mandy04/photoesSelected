...
@interface TweetSendImagesCell()<UICollectionViewDataSource,UICollectionViewDelegate>
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        if (!self.mediaView) {
            ...
            self.mediaView = [[UICollectionView alloc] initWithFrame:CGRectMake(15, 20, kScreen_Width-2*15, 80) collectionViewLayout:layout];
